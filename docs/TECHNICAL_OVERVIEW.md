> **HISTORICAL ARCHITECTURE SNAPSHOT (2026-05-13). Do not use its numeric results as current facts.** Use the executable checks and root `README.md`, `HONEST_VALUE.md`, and `CLAUDE.md` for current graph, benchmark, provenance, and packaging state. As of 2026-08-01 the strict core run is AUROC 0.9763 / AUPRC 0.5920; external performance remains unmeasured.
