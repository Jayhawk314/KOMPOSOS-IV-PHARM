...
**Last updated:** 2026-05-12 (strategy count corrected, see TECHNICAL_OVERVIEW.md for current state)
...
|
|-- oracle/                 22 files   Categorical oracle (7 production + experimental strategies, verifiers, learner, optimizer)
