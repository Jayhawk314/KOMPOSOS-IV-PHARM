...
# KOMPOSOS-IV-PHARM Legacy Docs

This directory is a historical archive. Use `truedocs/` and the executable
validation scripts for current Track A drug-repurposing numbers and provenance
claims.
...
See `truedocs/README.md` for current documentation.
