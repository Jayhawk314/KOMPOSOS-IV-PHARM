...
> **Note (2026-05-12):** This analysis was written 2026-04-07. For current drug
> repurposing metrics and validation, see `TECHNICAL_OVERVIEW.md` and `CURRENT_STATE.md`.
> Tests: 156 (up from 151). Production benchmark uses 7 of 22 strategies.
