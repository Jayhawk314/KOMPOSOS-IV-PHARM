> **HISTORICAL SNAPSHOT (2026-05-11). Do not use the numbers below as current facts.** The current sources of truth are the executable checks, root `README.md`, `HONEST_VALUE.md`, and `CLAUDE.md`. As of 2026-08-01 the strict core run is AUROC 0.9763 / AUPRC 0.5920 over 1,560 pairs and 44 local labels; external performance remains unmeasured.
