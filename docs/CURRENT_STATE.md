> **Legacy/historical notice (2026-05-27):** This file is retained for background or session history. It is not the current source of truth for Track A metrics or provenance. Current docs are in `truedocs/`, especially `truedocs/VALIDATION_AND_BENCHMARKS.md` and `truedocs/REPRODUCIBILITY_PROTOCOL.md`. Current strict run (2026-06-02): AUROC 0.970549 [0.9519, 0.9844], AUPRC 0.546427 [0.4025, 0.6890], Hits@5/10/20 1.0000/0.6000/0.6000; LOOCV AUROC 0.967431 and AUPRC 0.516478; Hetionet external AUROC 0.643615 and AUPRC 0.009513. Source strings exist on all 2,329 morphisms with 955 PMID identifiers; this is not 100% edge-specific citation validation. Retired or superseded claims in this file should be read as historical.
