...
> **Note (2026-05-12):** This doc was written 2026-04-07 and describes the full
> architecture. For current drug repurposing metrics, validation results, and
> production strategy details, see `TECHNICAL_OVERVIEW.md` and `CURRENT_STATE.md`.
> The benchmark harness uses 7 of the 22 strategies described here. Tests: 156 (up from 151).
